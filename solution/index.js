...
const foundId = Tasks[idForUse].indexOf(document.getElementById(currTaskId).textContent);
Tasks[idForUse][foundId] = document.getElementById(currTaskId + '-input').value;
localStorage.tasks = JSON.stringify(Tasks);
...
///when blur
inputLi.addEventListener('blur', () =>  blurFunction(currTaskId));
